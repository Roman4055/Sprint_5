...
class PageLocators:
    ...
    ERROR_MESSAGE = (By.XPATH, "//p[text() ='Такой пользователь уже существует']")  # Сообщение об ошибке валидации
    ...
    LOGIN_SUBMIT = (By.XPATH, ".//button[text()='Войти']")# Кнопка "Войти" видна в форме входа
    BUTTON_PERSONAL_ACCOUNT = (By.XPATH, ".//p[text()= 'Личный Кабинет']") # Кнопка "Личный кабинет" на стартовой странице
    ...
    BUTTON_AUTH_PERSONAL_CABINET = (By.XPATH, "//p[text()='Личный Кабинет']") # Кнопка "Личный кабинет" для авторизованного пользователя
    ...
    PROFILE_EDITOR = (By.XPATH, "//p[text()= 'В этом разделе вы можете изменить свои персональные данные']") #Поле имя в редакторе провиля
